...
<body>
    ...
    $sql_select = 'select * from food_drink,menu WHERE food_drink.F_D_ID = menu.menu_ID';
    ...
    if (isset($_POST['submit'])) {
        ...
        if (!empty($_POST['F_D_ID']) && !empty($_POST['F_name']) ) {
            ...
            $uploadFile = $_FILES['image']['cus_name'];
            $tmpFile = $_FILES['image']['tmp_name'];
            echo " upload file = " . $uploadFile;
            echo " tmp file = " . $tmpFile;

            $sql = "insert into customer 
							values (:F_D_ID, :F_name, :F_price, :menu_ID)";
        ...
        <div class="row">
            <div class="col-md-4"> <br>
                ...
                <form action="addFood.php" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" placeholder="Food_ID" name="F_D_ID" required>
                    <br> <br>
                    <input type="text" placeholder="F_Name" name="F_name" required>
                    <br> <br>
                    <input type="number" placeholder="F_price" name="F_price">
                    <br> <br>
                    <input type="text" placeholder="menu_ID" name="menu_ID">
                    <br> <br>
                    แนบรูปภาพ:
